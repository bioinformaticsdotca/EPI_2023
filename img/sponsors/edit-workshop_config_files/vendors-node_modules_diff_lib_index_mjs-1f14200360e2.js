...
`)&&(n=n.slice(0,-1))),r.prototype.equals.call(this,e,n,t)},new r().tokenize=function(e){return e.split(/(\S.+?[.!?])(?=\s+|$)/)},new r().tokenize=function(e){return e.split(/([{}:;,]|\s+)/)};var L=new r;L.useLongestToken=!0,L.tokenize=m.tokenize,L.castInput=function(e,n){var t=n.undefinedReplacement,r=n.stringifyReplacer,o=void 0===r?function(e,n){return void 0===n?t:n}:r;return"string"==typeof e?e:JSON.stringify(function e(n,t,r,o,i){for(t=t||[],r=r||[],o&&(n=o(i,n)),l=0;l<t.length;l+=1)if(t[l]===n)return r[l];if("[object Array]"===Object.prototype.toString.call(n)){for(t.push(n),u=Array(n.length),r.push(u),l=0;l<n.length;l+=1)u[l]=e(n[l],t,r,o,i);return t.pop(),r.pop(),u}if(n&&n.toJSON&&(n=n.toJSON()),"object"===k(n)&&null!==n){t.push(n),u={},r.push(u);var l,u,a,s=[];for(a in n)Object.prototype.hasOwnProperty.call(n,a)&&s.push(a);for(s.sort(),l=0;l<s.length;l+=1)u[a=s[l]]=e(n[a],t,r,o,a);t.pop(),r.pop()}else u=n;return u}(e,null,null,o),o,"  ")},L.equals=function(e,n,t){return r.prototype.equals.call(L,e.replace(/,([\r\n])/g,"$1"),n.replace(/,([\r\n])/g,"$1"),t)};var P=new r;function j(e){var n=e.split(/\n/),t=[],r=0;function o(e){var t=/^(---|\+\+\+)\s+(.*)\r?$/.exec(n[r]);if(t){var o="---"===t[1]?"old":"new",i=t[2].split("	",2),l=i[0].replace(/\\\\/g,"\\");/^".*"$/.test(l)&&(l=l.substr(1,l.length-2)),e[o+"FileName"]=l,e[o+"Header"]=(i[1]||"").trim(),r++}}for(;r<n.length;)!function(){var e={};for(t.push(e);r<n.length;){var i=n[r];if(/^(\-\-\-|\+\+\+|@@)\s/.test(i))break;var l=/^(?:Index:|diff(?: -r \w+)+)\s+(.+?)\s*$/.exec(i);l&&(e.index=l[1]),r++}for(o(e),o(e),e.hunks=[];r<n.length;){var u=n[r];if(/^(Index:\s|diff\s|\-\-\-\s|\+\+\+\s|===================================================================)/.test(u))break;if(/^@@/.test(u))e.hunks.push(function(){var e=r,t=n[r++].split(/@@ -(\d+)(?:,(\d+))? \+(\d+)(?:,(\d+))? @@/),o={oldStart:+t[1],oldLines:void 0===t[2]?1:+t[2],newStart:+t[3],newLines:void 0===t[4]?1:+t[4],lines:[]};0===o.oldLines&&(o.oldStart+=1),0===o.newLines&&(o.newStart+=1);for(var i=0,l=0;r<n.length&&(l<o.oldLines||i<o.newLines||null!=(u=n[r])&&u.startsWith("\\"));r++){var u,a=0==n[r].length&&r!=n.length-1?" ":n[r][0];if("+"===a||"-"===a||" "===a||"\\"===a)o.lines.push(n[r]),"+"===a?i++:"-"===a?l++:" "===a&&(i++,l++);else throw Error("Hunk at line ".concat(e+1," contained invalid line ").concat(n[r]))}if(i||1!==o.newLines||(o.newLines=0),l||1!==o.oldLines||(o.oldLines=0),i!==o.newLines)throw Error("Added line count did not match for hunk at line "+(e+1));if(l!==o.oldLines)throw Error("Removed line count did not match for hunk at line "+(e+1));return o}());else if(u)throw Error("Unknown line "+(r+1)+" "+JSON.stringify(u));else r++}}();return t}function O(e,n){var t,r,o=arguments.length>2&&void 0!==arguments[2]?arguments[2]:{};if("string"==typeof n&&(n=j(n)),Array.isArray(n)){if(n.length>1)throw Error("applyPatch only works with a single input.");n=n[0]}(o.autoConvertLineEndings||null==o.autoConvertLineEndings)&&(!e.includes(`\r
`)||e.startsWith(`
...
`),l=n.hunks,u=o.compareLine||function(e,n,t,r){return n===r},a=o.fuzzFactor||0,s=0;if(a<0||!Number.isInteger(a))throw Error("fuzzFactor must be a non-negative integer");if(!l.length)return e;for(var f="",c=!1,h=!1,v=0;v<l[l.length-1].lines.length;v++){var p=l[l.length-1].lines[v];"\\"==p[0]&&("+"==f[0]?c=!0:"-"==f[0]&&(h=!0)),f=p}if(c){if(h){if(!a&&""==i[i.length-1])return!1}else if(""==i[i.length-1])i.pop();else if(!a)return!1}else if(h){if(""!=i[i.length-1])i.push("");else if(!a)return!1}for(var d=[],g=0,m=0;m<l.length;m++){for(var y=l[m],w=void 0,k=i.length-y.oldLines+a,S=void 0,C=0;C<=a;C++){for(var L=function(e,n,t){var r=!0,o=!1,i=!1,l=1;return function u(){if(r&&!i){if(o?l++:r=!1,e+l<=t)return e+l;i=!0}if(!o)return(i||(r=!0),n<=e-l)?e-l++:(o=!0,u())}}(S=y.oldStart+g-1,s,k);void 0!==S&&!(w=function e(n,t,r){for(var o=arguments.length>3&&void 0!==arguments[3]?arguments[3]:0,l=!(arguments.length>4)||void 0===arguments[4]||arguments[4],a=arguments.length>5&&void 0!==arguments[5]?arguments[5]:[],s=arguments.length>6&&void 0!==arguments[6]?arguments[6]:0,f=0,c=!1;o<n.length;o++){var h=n[o],v=h.length>0?h[0]:" ",p=h.length>0?h.substr(1):h;if("-"===v)if(u(t+1,i[t],v,p))t++,f=0;else{if(!r||null==i[t])return null;return a[s]=i[t],e(n,t+1,r-1,o,!1,a,s+1)}if("+"===v){if(!l)return null;a[s]=p,s++,f=0,c=!0}if(" "===v)if(f++,a[s]=i[t],u(t+1,i[t],v,p))s++,l=!0,c=!1,t++;else{if(c||!r)return null;return i[t]&&(e(n,t+1,r-1,o+1,!1,a,s+1)||e(n,t+1,r-1,o,!1,a,s+1))||e(n,t,r-1,o+1,!1,a,s)}}return s-=f,t-=f,a.length=s,{patchedLines:a,oldLineLastI:t-1}}(y.lines,S,C));S=L());if(w)break}if(!w)return!1;for(var P=s;P<S;P++)d.push(i[P]);for(var O=0;O<w.patchedLines.length;O++){var E=w.patchedLines[O];d.push(E)}s=w.oldLineLastI+1,g=S+1-y.oldStart}for(var A=s;A<i.length;A++)d.push(i[A]);return d.join(`
`)}function E(e,n,t,r,o,i,l){if(l||(l={}),"function"==typeof l&&(l={callback:l}),void 0===l.context&&(l.context=4),l.newlineIsToken)throw Error("newlineIsToken may not be used with patch-generation functions, only with diffing functions");if(!l.callback)return a(y(t,r,l));var u=l.callback;function a(t){if(t){t.push({value:"",lines:[]});for(var r=[],u=0,a=0,s=[],f=1,c=1,h=0;h<t.length;h++)!function(){var e=t[h],n=e.lines||function(e){var n=e.endsWith(`
`),t=e.split(`
`).map(function(e){return e+`
`});return n?t.pop():t.push(t.pop().slice(0,-1)),t}(e.value);if(e.lines=n,e.added||e.removed){if(!u){var o=t[h-1];u=f,a=c,o&&(s=l.context>0?g(o.lines.slice(-l.context)):[],u-=s.length,a-=s.length)}(i=s).push.apply(i,S(n.map(function(n){return(e.added?"+":"-")+n}))),e.added?c+=n.length:f+=n.length}else{if(u)if(n.length<=2*l.context&&h<t.length-2)(v=s).push.apply(v,S(g(n)));else{var i,v,p,d=Math.min(n.length,l.context);(p=s).push.apply(p,S(g(n.slice(0,d))));var m={oldStart:u,oldLines:f-u+d,newStart:a,newLines:c-a+d,lines:s};r.push(m),u=0,a=0,s=[]}f+=n.length,c+=n.length}}();for(var v=0;v<r.length;v++)for(var p=r[v],d=0;d<p.lines.length;d++)p.lines[d].endsWith(`
`)?p.lines[d]=p.lines[d].slice(0,-1):(p.lines.splice(d+1,0,"\\ No newline at end of file"),d++);return{oldFileName:e,newFileName:n,oldHeader:o,newHeader:i,hunks:r}}function g(e){return e.map(function(e){return" "+e})}}y(t,r,b(b({},l),{},{callback:function(e){u(a(e))}}))}function A(e){if(Array.isArray(e))return e.map(A).join(`
...
//# sourceMappingURL=vendors-node_modules_diff_lib_index_mjs-9ec421333f13.js.map